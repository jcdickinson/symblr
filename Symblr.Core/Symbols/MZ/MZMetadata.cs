...
{
    /// <summary>Represents metadata about an MZ file.</summary>
    internal sealed class MZMetadata : ISymbolMetadata
    {
        private static readonly byte[] _mzHeader = new byte[] { 0x4D, 0x5A };
        private static readonly byte[] _peHeader = new byte[] { 0x50, 0x45, 0x00, 0x00 };
        ...
        /// <returns>
        /// A <see cref="Task{MzMetadata}" /> that represents the asynchronous open operation.
        /// </returns>
        [SuppressMessage("StyleCopPlus.StyleCopPlusRules", "SP0100:AdvancedNamingRules", Justification = "Used to enhance meaning.")]
